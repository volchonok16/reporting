/** Колонки вкладок «Активности по выручкам». */

export const REVENUE_ACTIVITY_BASE_COLUMNS = [
  'Активность',
  'Статус F2 2026',
  'Ответственный',
  'Влияние на базу, тыс',
...
export const REVENUE_ACTIVITY_REVENUE_COLUMNS = [
  'Активность',
  'Статус F2 2026',
  'Ответственный',
...
/** @deprecated Используйте колонки конкретной вкладки (base / revenue). */
