...
Одинаковый **alias** у нескольких строк — одна вкладка в UI; синк и дашборд объединяют все `area_path` (склейка стримов, без дублирования вкладок).
...
| `zni_external_data` | Внешние поля ЗНИ (не TFS): приоритет, категория, коммерческий эффект, даты, комментарий | — |
| `zni_category` | Справочник категорий ЗНИ (допполе «Категория») | — |
