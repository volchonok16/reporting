...
| `gid` | Вкладка | Колонки |
|-------|---------|---------|
| `base` | Влияние по базе | «Активность», «Статус F2 2026», «Ответственный», «Влияние на базу, тыс», «Влияние на gmc, млн», «Комментарий» |
| `revenue` | Влияние по выручке | «Активность», «Статус F2 2026», «Ответственный», «Влияние на выручку, млн», «Маржа», «Влияние на gmc, млн», «Комментарий» |
