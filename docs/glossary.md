...
Фиксированные ключи в `cells`: «Дата запуска», «Проект координация» (редактируют только админы), «Полное Описание проекта и статус», «Для презентации Описание проекта и статус», «Зачем и для чего делаем полное описание», «Зачем и для чего делаем для презентации», «ЗНИ» (несколько номеров через запятую с пробелом, напр. `123456, 789012`), «Идет в презентацию», «Обратить внимание», «Комментарий» (служебный, не в презентацию).
