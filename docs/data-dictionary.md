...
| `revenue_activity_row` | `section_id`, `sort_order`, `cells` | Строки; общие поля + «Влияние на базу, тыс» (`base`) или «Влияние на выручку, млн» (`revenue`), «Влияние на gmc, млн», «Комментарий» |
